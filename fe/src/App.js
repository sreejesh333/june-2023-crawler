...
<div className="lyrics">
        ...
        {lyrics.map((lyric, idx) => (
          <div key={idx}>
            ...
            {lyrics.length > 0 && (
            <div>
            <a className="youtube"href={lyric.youtubelink}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-youtube" viewBox="0 0 16 16">
