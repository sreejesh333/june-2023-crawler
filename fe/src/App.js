...
<div className="lyrics">
        ...
        {lyrics.map((lyric, idx) => (
          <div key={idx}>
            ...
            {
            <div className='icons'>
            <a className="youtube"href={lyric.youtubelink}><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-youtube" viewBox="0 0 16 16">
